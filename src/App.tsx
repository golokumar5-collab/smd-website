...
const ANDROID_DOWNLOAD = '/download/SMD-PRO-v1.2.0.apk';
          ...
          <div className="container">
            ...
            <div className="product-grid">
              <article className="product-card product-android">
                ...
                <a className="download-link" href={ANDROID_DOWNLOAD} download="SMD-PRO-v1.2.0.apk">
        ...
        <section className="section download-section" id="download">
          <div className="container download-panel">
            ...
            <div className="download-options">
              <a className="download-option" href={ANDROID_DOWNLOAD} download="SMD-PRO-v1.2.0.apk">
                <span className="download-platform"><AndroidMark /></span>
                <span className="download-details"><small>Android mobile</small><strong>Download SMD PRO</strong><em>v1.2.0 • APK • 76.7 MB</em></span>
