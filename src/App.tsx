...
const ANDROID_DOWNLOAD = '/download/SMD-PRO-v1.3.2.apk';
          ...
          <div className="container">
            ...
            <div className="product-grid">
              <article className="product-card product-android">
                ...
                <a className="download-link" href={ANDROID_DOWNLOAD} download="SMD-PRO-v1.3.2.apk">
                  <span><DownloadIcon /> Android APK download</span><small>APK • 76.8 MB</small>
                </a>
              </article>
        ...
        <section className="section download-section" id="download">
          <div className="container download-panel">
            ...
            <div className="download-options">
              <a className="download-option" href={ANDROID_DOWNLOAD} download="SMD-PRO-v1.3.2.apk">
                <span className="download-platform"><AndroidMark /></span>
                <span className="download-details"><small>Android mobile</small><strong>Download SMD PRO</strong><em>v1.3.2 • APK • 76.8 MB</em></span>
